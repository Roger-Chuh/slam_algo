function [curPredPtIcs,inTraceFlag,curPredPtIcs0,inTraceFlag0,weightRaw,candX,candY,errPair,objPervPtCcsZGolden1] = NewTracking_bak(obj,keyFeatNum,prevFeatPtList,ptCcsZ,intrMat,k2cRef,angleModalOrg, keyDepthV, prevDepthV, currDepthV,DepthProbility, DepthId, AngleProbility,reCalc,DispRefineUse__,DispRng,objPervPtCcsZGolden,ThetaNoise,CamModel,CoordSysAligner,LocalTrace,imgCur,imgPrvL,REFAngList,REFAngList4,prvDepthVisual,prvDepthGT)
