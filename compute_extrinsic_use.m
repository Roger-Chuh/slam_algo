function [omckk,Tckk,Rckk,H,x,ex,JJ] = compute_extrinsic_use(x_kk,X_kk,fc,cc,kc,alpha_c,MaxIter,thresh_cond),
...
[omckk,Tckk,Rckk] = compute_extrinsic_init_use(x_kk,X_kk,fc,cc,kc,alpha_c);

% Refinement:
[omckk,Tckk,Rckk,JJ] = compute_extrinsic_refine_use(omckk,Tckk,x_kk,X_kk,fc,cc,kc,alpha_c,MaxIter,thresh_cond);
