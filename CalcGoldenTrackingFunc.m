function error = CalcGoldenTrackingFunc(obj, intrMat, dispErrExpStack, newCalc, b2cVec)
global probPath
% 
b2c = [rodrigues(b2cVec(1:3)) [10;45;-170.2];0 0 0 1];
% b2c = [rodrigues(b2cVec(1:3)) [b2cVec(4:6)];0 0 0 1];
% b2c = [rodrigues([0;0;0]) [b2cVec(1:3)];0 0 0 1];
draw = 0;
...
error = 1000.*abs(trackingErrStack(:,2));
