function [angOpt, inlierId, angRng, PixUse, pt2dCurUse, DispRefineUse_, angOpt3, inFlag,thetaRngOut,thetaProbOut,angOptP2C, angOptK2C_, p2cOnlyP2_111,...
    ...
    meanErrAndStd,...
    p2cErrList,...        
    objPervPtCcsZGolden1] = RefineZ_bak(k2cRef_00, obj, k2cRef,k2cPnp, inlierId0, inlierId2, theta, DepthProbility,  DepthId,  AngleModalOrg,  AngleProbility,prevFeatPtList0,ptCcsZ0,DispRefineUse__,NewDispRng,newDispStep,ProbZTmpReSamp,k2cBody,...
    keyFrameLen ,...
    disparity_resample_prob_threshold,...
    ThetaNoise ,...
    KeyFrameFlagList,...
