...
imgL = imread(fullfile(inputDir, dirInfo(imgInd + length(dirInfo)/2).name));
try
...
ratioList =  0.2480; [0.3:-0.001:0.2];
dir1 = xz2(end,:) - xz2(1,:);
dir1 = dir1./norm(dir1);
cnt = 1;
in = {};
...
img2 = ImgTransform(rgb2gray(imgLL), intrMat, R2);
img22 = ImgTransform(rgb2gray(imgLL), intrMat, R2');
