function [thetaProbUse, thetaProbUse_, thetaProbUse__, curPredPtIcs, weightRaw, candX, candY,candX_reshape, candY_reshape, weightRaw_reshape,idff] = UpdateNewTracking(obj, thetaSamp, thetaProb, prevFeatPtList0, ptCcsZ0, intrMat, AngleModalOrg, DepthProbility, DepthId, inlierId, DispRng,DispRefineUse__)
global NewOnlyP2
...
%     CalcCandXYWeight(obj, size(obj.featPtManager.localTrace.ptIcsX,1),prevFeatPtList0,ptCcsZ0,intrMat, obj.currRefRobotRotAngWcs - obj.keyRefRobotRotAngWcs, AngleModalOrg, obj.keyFrameDepth, obj.prvDepthVisual, inlierId,DepthProbility, DepthId, thetaProbUse__,1, DispRng)
    [curPredPtIcs,inTrackFlag,curPredPtIcs0,inTrackFlag0,weightRaww,candXX,candYY] = VisualLocalizer.NewTrackingTemp(obj, size(obj.featPtManager.localTrace.ptIcsX,1),prevFeatPtList0,ptCcsZ0,intrMat, obj.currRefRobotRotAngWcs - obj.keyRefRobotRotAngWcs, AngleModalOrg, obj.keyFrameDepth, obj.prvDepthVisual, inlierId,DepthProbility, DepthId, thetaProbUse__,1, DispRng,DispRefineUse__);
end
