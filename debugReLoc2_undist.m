...
%     img = imread('C:\Users\rongjiezhu\Desktop\imgL.jpg');
    ...
    pt2dline = [1475 611; 1428 88; 1200 642; 1184 347;1110 618; 1104 439; 489 646; 483 472; 281 655; 279 404];
    pt2dz = [1813 816; 1147 665; 1371 935;1011 667; 716 811; 873 677; 149 839; 728 679];
    
    pt2dline = undist_pt(pt2dline, K ,kc);
    pt2dz = undist_pt(pt2dz, K ,kc);
    
    
    pt2d = pt2dline([1 2 4 5 6 8 10 9],:);
...
%     [poseVec1] = BuildSemanticDepth(img, K, pt3dline(1:6,:), pt3d2([1 2 7 8],:), pt2dline(1:6,:), pt2dz([1 2 7 8],:), poseVec1, [1 1]);
    ...
    [poseVec1] = BuildSemanticDepth(img, K, pt3dline([3 4 5 6 7 8],:), pt3d2([1 2 3 4 5 6 7 8],:), pt2dline([3 4  5 6 7 8],:), pt2dz([1 2 3 4 5 6 7 8],:), rtTemp, [1 1]);
...
function pt2d = undist_pt(pt2d0, K ,kc)
