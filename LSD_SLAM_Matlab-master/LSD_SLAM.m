        ...
        function demo
            ...
            %}
                if 0
                    ...
                    load('G:\matlab\LK\slam_algo\LSD_SLAM_Matlab-master\data.mat');
                end
            ...
            cam_info.P = reshape(cam_info_Msgs{1}.P,4,3)';
                ...
                slamSystem = SlamSystem(cam_info.K,640,480);
            ...
            imageA = 1./reshape(typecast(depth_Msgs{imageIdx}.Data,'single'),640,480)';
            ...
            figure(100),imshow([keyFrame imageA2]);drawnow;
            end
