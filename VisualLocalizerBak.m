classdef VisualLocalizerBak < BaseLocalizer
                ...
                if 1 %sum(inTrackFlag) > obj.configParam.min_num_pt_for_calculate
                    ...
                    if PNP_FLAG
                        ...
                        try
                            ...
                            [k2cBodyRotAng, reprojError] = RotationAngleEstimate_PNP(obj.pureRotationAngPredictor,intrMat,obj.featPtManager,obj.coordSysAligner,k2cRef,obj.keyFrameFlagList,obj.frmStampList,obj.goldenPose);
                            deltaVision2BodySensor = abs(rad2deg(k2cBodyRotAng-k2cBodySensorRotAng));
                            if deltaVision2BodySensor > 200 %0.1
...
%             reProjErr = abs(mean(dis(flag) )); %sum(dis(flag))/Rows(Point3D(flag));
    ...
    methods
        ...
        function SetDefaultValue(obj, cfgParam)
            ...
            cfgParam = Configurable.SetField(cfgParam, 'feature_num_drop_rate_thresh', 0.95);
