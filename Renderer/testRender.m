function [x_err, y_err, x_err_stack, y_err_stack, TCur_cam, cbcXYZL, mappingErr, TCur_cam_stack, ptTrace, vecAngMatCW, vecAngMatCCW, vecAngMatCW_y, vecAngMatCCW_y, gtRemapErr] = testRender(vsl, theta, poseStack, ptTrace0)
...
if shortTrace
    ...
    sampNum = 14*angSize;  14; 4; 3; 2; 14; 28; 14; 8; 7; 14;100;
end
...
XYZ_stack = [];
if rot_y
    angStep = 2.8/angSize;   2.8; 1.4; % close
%     angStep = 52,8;  % far
else
