function [camPoseMatNew,accumAng1] = reBase_inv(camPoseMat2,dltT0)
accumAng1 = 0;
...
% %     Tnew(1:3,4) = [Tnew([3 1 2],4)];
    ...
    Tnew(1:3,1:3) = [Tnew([2 3 1],1:3)];
    Tnew(1:3,1:3) = [-Tnew(1:3,[2]) Tnew(1:3,[3]) -Tnew(1:3,[1])];
    Tnew(1:3,4) = [Tnew([2 3 1],4)];
