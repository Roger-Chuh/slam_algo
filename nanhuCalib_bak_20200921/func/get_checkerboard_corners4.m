...
function [callBack, Xp_abss, Yp_abss] = get_checkerboard_corners4(kk,use_corner_find,calib_data,calibFuncDir)

fclose('all');
% if exist('D:\nextvpu\algorithm\src\matlibs\computer_vision\camera_calibration\Scaramuzza_OCamCalib_v3.0_win\autoCornerFinder/cToMatlab/cornerInfo.txt','file')
%     delete('D:\nextvpu\algorithm\src\matlibs\computer_vision\camera_calibration\Scaramuzza_OCamCalib_v3.0_win\autoCornerFinder/cToMatlab/cornerInfo.txt');
% end
% if exist('D:\nextvpu\algorithm\src\matlibs\computer_vision\camera_calibration\Scaramuzza_OCamCalib_v3.0_win\autoCornerFinder/cToMatlab/cornersX.txt','file')
%     delete('D:\nextvpu\algorithm\src\matlibs\computer_vision\camera_calibration\Scaramuzza_OCamCalib_v3.0_win\autoCornerFinder/cToMatlab/cornersX.txt');
% end
% if exist('D:\nextvpu\algorithm\src\matlibs\computer_vision\camera_calibration\Scaramuzza_OCamCalib_v3.0_win\autoCornerFinder/cToMatlab/cornersY.txt','file')
%     delete('D:\nextvpu\algorithm\src\matlibs\computer_vision\camera_calibration\Scaramuzza_OCamCalib_v3.0_win\autoCornerFinder/cToMatlab/cornersY.txt');
% end
% if exist('D:\nextvpu\algorithm\src\matlibs\computer_vision\camera_calibration\Scaramuzza_OCamCalib_v3.0_win\autoCornerFinder/cToMatlab/error.txt','file')
%     delete('D:\nextvpu\algorithm\src\matlibs\computer_vision\camera_calibration\Scaramuzza_OCamCalib_v3.0_win\autoCornerFinder/cToMatlab/error.txt');
% end


if exist(strcat(calibFuncDir,'/autoCornerFinder/cToMatlab/cornerInfo.txt'),'file')
    delete(strcat(calibFuncDir,'/autoCornerFinder/cToMatlab/cornerInfo.txt'));
end
if exist(strcat(calibFuncDir,'/autoCornerFinder/cToMatlab/cornersX.txt'),'file')
    delete(strcat(calibFuncDir,'/autoCornerFinder/cToMatlab/cornersX.txt'));
end
if exist(strcat(calibFuncDir,'/autoCornerFinder/cToMatlab/cornersY.txt'),'file')
    delete(strcat(calibFuncDir,'/autoCornerFinder/cToMatlab/cornersY.txt'));
end
if exist(strcat(calibFuncDir,'/autoCornerFinder/cToMatlab/error.txt'),'file')
    delete(strcat(calibFuncDir,'/autoCornerFinder/cToMatlab/error.txt'));
end


%INITIALIZATIONS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fprintf(1,'\nProcessing image %s...',calib_data.L{kk}(1:end));
...
% % % fid = fopen('D:\nextvpu\algorithm\src\matlibs\computer_vision\camera_calibration\Scaramuzza_OCamCalib_v3.0_win\autoCornerFinder/pictures.txt','w');
fid = fopen(strcat(calibFuncDir,'/autoCornerFinder/pictures.txt'),'w');
...
% % cd 'D:\nextvpu\algorithm\src\matlibs\computer_vision\camera_calibration\Scaramuzza_OCamCalib_v3.0_win\autoCornerFinder';
cd (fullfile(calibFuncDir,'autoCornerFinder'));
...
if callBack ~= 1
    %Display the error message
% % %     filename = 'D:\nextvpu\algorithm\src\matlibs\computer_vision\camera_calibration\Scaramuzza_OCamCalib_v3.0_win\autoCornerFinder\cToMatlab/error.txt';
    filename = strcat(calibFuncDir,'\autoCornerFinder\cToMatlab\error.txt');
...
% % filename = 'D:\nextvpu\algorithm\src\matlibs\computer_vision\camera_calibration\Scaramuzza_OCamCalib_v3.0_win\autoCornerFinder\cToMatlab/cornerInfo.txt';
filename = strcat(calibFuncDir,'\autoCornerFinder\cToMatlab\cornerInfo.txt');
...
% % % filename = 'D:\nextvpu\algorithm\src\matlibs\computer_vision\camera_calibration\Scaramuzza_OCamCalib_v3.0_win\autoCornerFinder\cToMatlab/cornersX.txt';
filename = strcat(calibFuncDir,'\autoCornerFinder\cToMatlab\cornersX.txt');
...
% % % filename = 'D:\nextvpu\algorithm\src\matlibs\computer_vision\camera_calibration\Scaramuzza_OCamCalib_v3.0_win\autoCornerFinder\cToMatlab/cornersY.txt';
filename = strcat(calibFuncDir,'\autoCornerFinder\cToMatlab\cornersY.txt');
    ...
    for j = 1:1:(cols-deltaCols)
        if cornersX(i,j) ~= -1
            ...
            if use_corner_find
                ...
                [xxi] = cornerfinder([cornersX(i,j);cornersY(i,j)],I,5,5);  %winty,wintx);
                %Save for plotting later
...
% % Xp_abss = reshape(Xp_abs,(calib_data.n_sq_x+1),(calib_data.n_sq_y+1))';
% % Yp_abss = reshape(Yp_abs,(calib_data.n_sq_x+1),(calib_data.n_sq_y+1))';
Xp_abss = cornersX(((cornerInfo(1) - iSave + 2):end),:);
Yp_abss = cornersY(((cornerInfo(1) - iSave + 2):end),:);
