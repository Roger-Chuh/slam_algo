% function [xRectMatUse, yRectMatUse,KK_new, Kinit,k,imgL1, LutVecCharX, LutVecCharY, SplitIndX, SplitIndY,lutVecX,lutVecY] = RemapPixel_tmp(I,R,f,c,k,alpha,KK_new,imgL,stepXY,reverseMapping,varargin)
function [newXSAmple] = RemapPixel_tmp(I,R,f,c,k,alpha,KK_new,imgL,stepXY,reverseMapping,varargin)
...
if 0
    optVec = OptBilinear(pixOrigAll, pixOrig_2, xuu2, xuuAll, rowNew, colNew, nr,nc);
