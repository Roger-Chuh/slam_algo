...
if 1 % large resolution
    [saddles] = cornerfinder_saddle_point( flipud(saddles_0), I, 11,11 ); %for sharp images: 5x5, 11, 3, 7,21,17,19
    [saddles,good] = cornerfinder_saddle_point( saddles, I,9,9 ); %for sharp images: 3x3, 9, 1, 5,19,15,15
...
% % % [ipt0] = cornerfinder(iPt(:,[2 1])',double(rgb2gray(rectImgR)),config.halfWinW,config.halfWinH);
