function [H, inliers, trials, T1, T2, sampleSet] = ransacfithomography_(x1, x2, t, normalize, updateMethod, inpSampleSet, normType, loransacInlThreshold, matchingScores)
