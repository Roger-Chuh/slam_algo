function [camParam, cbcXY, cbGrid, config, calib_data, cbcXYTmp, cbGridTmp, goodId] = CbCalibSingle4(cbImgList,cbcXYDetected,calibFuncDir,modeE, varargin)
