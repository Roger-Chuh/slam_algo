function [Irec,ind_new,ind_1,ind_2,ind_3,ind_4,a1,a2,a3,a4,imgL1] = rect_index_table5(I,R,f,c,k,alpha,KK_new,imgL)
...
for i = 1 : length(ySampled) - 1
    ...
    pixRect_1_nex = Orig2Rect([xuuAllUse(ySampled(i)+1,:); yuuAllUse(ySampled(i)+1,:)]', Kinit, KK_new, R,k);
