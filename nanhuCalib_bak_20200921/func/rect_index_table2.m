function [Irec,ind_new,ind_1,ind_2,ind_3,ind_4,a1,a2,a3,a4,imgL1] = rect_index_table2(I,R,f,c,k,alpha,KK_new,imgL);
...
for i = 1 : nr
    %     i=1080;
    pixRect_ = Orig2Rect([xuuAllUse(i,:); yuuAllUse(i,:)]', Kinit, KK_new, R,k);
