function [xRectMatUse, yRectMatUse,KK_new, Kinit,k,imgL1, LutVecCharX, LutVecCharY, SplitIndX, SplitIndY,lutVecX,lutVecY] = RemapPixel_bak(I,R,f,c,k,alpha,KK_new,imgL,stepXY,reverseMapping,varargin)
