function [Irec,ind_new,ind_1,ind_2,ind_3,ind_4,a1,a2,a3,a4,imgL1] = rect_index_table6(I,R,f,c,k,alpha,KK_new,imgL)
...
Pix2StackIn = [];
step = 1; 3;
yStep = 1;2;1;2;20; 3;15;3;10; 5; 10;
splitStep = 2; 3; 5;3; 5;
flag = false;
ySampled = [1:yStep:nr]';
if ySampled(end) ~= nr
...
for i = 1 : length(ySampled) - 1
    ...
    endPixRect = pixRect_1(end,:);
    startPixOrig = pixOrig_1(1,:);
    endPixOrig = pixOrig_1(end,:);
    if 0
        for yy = startPixRect(2):startPixRect(2)+50
            pixRect_up = [startPixRect(1):endPixRect(1);repmat(yy-1,1,length(startPixRect(1):endPixRect(1)))]';
            pixRect_cur = [startPixRect(1):endPixRect(1);repmat(yy,1,length(startPixRect(1):endPixRect(1)))]';
            pixRect_down = [startPixRect(1):endPixRect(1);repmat(yy+1,1,length(startPixRect(1):endPixRect(1)))]';
            
            Rect2Orig_up = remapRect(pixRect_up', KK_new,Kinit,k,R);
            Rect2Orig_cur = remapRect(pixRect_cur', KK_new,Kinit,k,R);
            Rect2Orig_down = remapRect(pixRect_down', KK_new,Kinit,k,R);
            
            y_up = Rect2Orig_up(:,2) - repmat(ySampled(i),size(Rect2Orig_up,1),1);
            y_cur = Rect2Orig_cur(:,2) - repmat(ySampled(i),size(Rect2Orig_cur,1),1);
            y_down = Rect2Orig_down(:,2) - repmat(ySampled(i),size(Rect2Orig_down,1),1);
            
            flag_up = find(Rect2Orig_up(:,2) >= ySampled(i) & Rect2Orig_up(:,2) < ySampled(i+1) & pixRect_up(:,2) > 0 & pixRect_up(:,2) <= nr);
            flag_cur = find(Rect2Orig_cur(:,2) >= ySampled(i) & Rect2Orig_cur(:,2) < ySampled(i+1) & pixRect_cur(:,2) > 0 & pixRect_cur(:,2) <= nr);
            flag_down = find(Rect2Orig_down(:,2) >= ySampled(i) & Rect2Orig_down(:,2) < ySampled(i+1) & pixRect_down(:,2) > 0 & pixRect_down(:,2) <= nr);
            figure(555),plot(pixRect_up(flag_up,1),pixRect_up(flag_up,2),'or');
            plot(pixRect_cur(flag_cur,1),pixRect_cur(flag_cur,2),'.g');
            plot(pixRect_down(flag_down,1),pixRect_down(flag_down,2),'sb');
            legend('up','cur','down');
        end
    end
    pix = startPixRect;
    pixFound = []; pixHoldup = [];pixHolddown = []; % pixWrite = [];
    if i == 145
        asvk = 1;
    end
    for j = startPixRect(1) : endPixRect(1)
        pixTmp = [repmat(j,3,1) [pix(2)-1 pix(2) pix(2)+1]'];
        Rect2OrigTmp = remapRect(pixTmp', KK_new,Kinit,k,R);
        flagTmp = find(Rect2OrigTmp(:,2) >= ySampled(i) & Rect2OrigTmp(:,2) < ySampled(i+1) & Rect2OrigTmp(:,2) > 0 & Rect2OrigTmp(:,2) <= nr & pixTmp(:,2) > 0 & pixTmp(:,2) <= nr);
        
        % assume there is no way 'length(flagTmp) == 3' could happen.
        
        if ismember(2,flagTmp)
            pixFound = [pixFound; pixTmp(2,:)];
        end
        if ismember(1,flagTmp)
            pixHoldup = [pixHoldup; pixTmp(1,:)];
            if ~ismember(2,flagTmp)
        ...
        if ismember(3,flagTmp)
            pixHolddown = [pixHolddown; pixTmp(3,:)];
            if ~ismember(2,flagTmp)
                pixWrite = [pixWrite;pixFound];
                if draw
                    figure(333),plot(pixFound(:,1),pixFound(:,2),'.','Color',rand(1,3));
                end
                pixFound = pixHolddown;
                pixHolddown = [];
                pix = pixTmp(3,:);
            end
        end
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     figure,plot([y_up y_cur y_down]);legend('up','cur','down');
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     %     Orig_2(flag2,:);
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     iddd1_2 = find(idd1 < 0);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     iddd1_1 = iddd1_1 +0;
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     %     pixRect_1(iddd1_1,2) = pixRect_1(iddd1_1,2) + 1;
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     iddd1_1 = iddd1_1 + 1;
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     if 0
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         iddd1_2 = iddd1_2 +0;
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     else
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     else
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         pixRect_2(iddd2_2,2) = pixRect_2(iddd2_2,2) + 0;
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     end
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     %     pixRect_2(iddd2_1,2) = pixRect_2(iddd2_1,2) -1;
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     %     iddd2_1 = iddd2_1 + 1;
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     end
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     splitX1 = [pixRect_1(iddd1,1)]; %;pixRect_2(iddd2,1)];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     splitX1 = unique(splitX1);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     splitX1 = [startX;splitX1;endX];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     splitX1 = unique(splitX1);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     splitX2 = [pixRect_2(iddd2,1)]; %;pixRect_2(iddd2,1)];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     splitX2 = unique(splitX2);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     splitX2 = [startX;splitX2;endX];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     splitX2 = unique(splitX2);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     splitXId1 = find(ismember(pixRect_1(:,1),splitX1));
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     splitXId2 = find(ismember(pixRect_2(:,1),splitX1));
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     %     if draw
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     %          figure(444),plot(pixRect_1(:,1),pixRect_1(:,2),'xr');plot(pixRect_2(:,1),pixRect_2(:,2),'.g');plot(pixRect_1(splitXId1,1),pixRect_1(splitXId1,2),'or');plot(pixRect_2(splitXId2,1),pixRect_2(splitXId2,2),'og')
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     %     end
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     for j = 1 : length(splitX1) -1
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         if j == 1
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             splitXiD1_1 = find(pixRect_1(:,1) == splitX1(j));
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         else
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             splitXiD1_1 = find(pixRect_1(:,1) == splitX1(j)-1);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         end
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         splitXiD1_2 = find(pixRect_1(:,1) == splitX1(j+1)-1);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         %         splitXiD2_1 = find(pixRect_2(:,1) == splitX1(j));
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         %         splitXiD2_2 = find(pixRect_2(:,1) == splitX1(j+1)-1);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         if 1 % isempty(splitXiD1_1)
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             grid11 = [splitX1(j)-1 pixRect_1(find(pixRect_1(:,1) == splitX1(j)-0),2)];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             %             Orig11 =
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         else
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             grid11 = pixRect_1(splitXiD1_1,:);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             %             OrigXStart = pixOrig_1(splitXiD1_1,1);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         end
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         if 1 %isempty(splitXiD1_2)
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             %             grid12 = [splitX1(j+1)-1 pixRect_1(find(pixRect_1(:,1) == splitX1(j+1)-3),2)];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             grid12 = [splitX1(j+1)-1 grid11(2)];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             origXEnd1 = [];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         else
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         try
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             gridTmp1 = [grid11;grid12];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         catch
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             askjd = 1;
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         end
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         origXEnd1_ = origXEnd1 + 1;
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         grid1 = [grid11;grid12];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         if draw
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             figure(333),plot(grid1([1 2],1),grid1([1 2],2),'r');
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         end
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     end
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     for jj = 1 : length(splitX2) -1
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         if jj == 1
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             splitXiD2_1 = find(pixRect_2(:,1) == splitX2(jj));
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         else
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             splitXiD2_1 = find(pixRect_2(:,1) == splitX2(jj)-1);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         end
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         splitXiD2_2 = find(pixRect_2(:,1) == splitX2(jj+1)-1);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         %         splitXiD2_1 = find(pixRect_2(:,1) == splitX1(j));
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         %         splitXiD2_2 = find(pixRect_2(:,1) == splitX1(j+1)-1);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         if 1 %isempty(splitXiD2_1)
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             grid21 = [splitX2(jj)-0 pixRect_2(find(pixRect_2(:,1) == splitX2(jj)-0),2)];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         else
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             grid21 = pixRect_2(splitXiD2_1,:);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             %             Orig21 = pixRect_2(splitXiD2_1,:);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         end
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         if 1 %isempty(splitXiD2_2)
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             try
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                 %                 grid22 = [splitX2(jj+1)-1 pixRect_2(find(pixRect_2(:,1) == splitX2(jj+1)-3),2)];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                 grid22 = [splitX2(jj+1)-1 grid21(2)];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             catch
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                 wafkh = 1;
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             end
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             origXEnd2 = pixOrig_2(find(pixRect_2(:,1) == splitX2(jj+1)-0),1);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         else
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         try
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             gridTmp2 = [grid21;grid22];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         catch
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             wasdghiu = 1;
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         end
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         origXEnd2_ = origXEnd2 + 1;
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         grid2 = [grid21;grid22];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         figure(333),plot(grid2([1 2],1),grid2([1 2],2),'g');
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     end
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     if draw
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         drawnow;
