classdef Setting_ < Configurable
...
%     methods
    ...
    methods
        function SetDefaultValue(obj, cfgParam)
            ...
            cfgParam = Configurable.SetField(cfgParam, 'disparityBoundary', 1);
            cfgParam = Configurable.SetField(cfgParam, 'disparityIntervel', 0.1);
            cfgParam = Configurable.SetField(cfgParam, 'angleBoundary', 0.5);
            cfgParam = Configurable.SetField(cfgParam, 'angleIntervel', 0.02);  % 0.02; % 0.05
