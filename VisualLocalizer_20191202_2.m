classdef VisualLocalizer < BaseLocalizer
    ...
    methods
        ...
        function Localize(obj, imgL, imgR, refMotionState, refRobotPoseWcs, frameInd)
            ...
            if  0  %size(obj.poseWcsList,1) == 33;  250; 97; 32; 81; 257
                doInsert = 2;
            end
...
%                         if 1
                            ...
                            if DRAWPOLYGON
                                if ~isempty(inlierId)
                                    ...
                                    if 1
                                        try
                                            [angOpt1, inlierIdNew,  angRng1, pixKey ,pt2dCur, DispRefine, angOpt33, inFlag,thetaRngOut,thetaProbOut,angOptP2C, angOptK2C_] = RefineZ(obj, k2cRef,k2cBodyRotAng, inlierId,inlierId2, theta, DepthProbility,  DepthId,  AngleModalOrg,  AngleProbility,prevFeatPtList0,ptCcsZ0,DispRefineUse__,NewDispRng,newDispStep,ProbZTmpReSamp);  %, keyCcsXYZAll);
...
%           function [angOpt, inlierId, angRng, PixUse, pt2dCurUse, DispRefineUse, angOpt3, inFlag] = RefineZ(obj, k2cRef,k2cPnp, inlierId0, inlierId2, theta, DepthProbility,  DepthId,  AngleModalOrg,  AngleProbility,prevFeatPtList0,ptCcsZ0)  %, XYZ)
          function [angOpt, inlierId, angRng, PixUse, pt2dCurUse, DispRefineUse_, angOpt3, inFlag,thetaRngOut,thetaProbOut,angOptP2C, angOptK2C_] = RefineZ(obj, k2cRef,k2cPnp, inlierId0, inlierId2, theta, DepthProbility,  DepthId,  AngleModalOrg,  AngleProbility,prevFeatPtList0,ptCcsZ0,DispRefineUse__,NewDispRng,newDispStep,ProbZTmpReSamp)  %, XYZ)
            global SHOWPOLYGON DRAWPOLYGON ANGLEONLY USEGOLDENDISP UPDATEDEPTH DEPTHITERNUM probPath ...
                ...
                NewPrvDispResamp Rati_onlyP2 NewFlow
...
% %                                 thetaP2C = k2cRef0 - obj.refAngList(end);
                                ...
                                if 1
                                    [thetaProbP2C,idMP2C,angOptP2C, ~, ~, ~, ~,~,~,~,~,ProbReprojVecAllP2C, ProbReprojVecRAllP2C, ~, ~, ~,~,~, ~, ~,~,~,~,~,~,~,thetaExp_tmpP2C] = ReplayTheta(obj, thetaRngP2C, b2c, prvCcsXYZAll, intrMat, pt2dPrv, disparityRng, baseline, ZZVecPrv1, L2R, pt2dCur, pt2dCurR, ProbZP2C, ProbZP2C_norm, imgCur, imgCurR,thetaSampP2C);
%                                     [thetaProbP2C_, angOptP2C, thetaExp_tmpP2C_, gtP2C] = New_OnlyP2(obj, pt2dPrv, pt2dCur, intrMat,thetaP2C,T_B2C, k2cRef0);
                                    ...
                                    if 0
                                        ...
                                        [thetaProbP2C, angOptP2C, thetaExp_tmpP2C, gtP2C] = New_OnlyP2(obj, pt2dPrv, pt2dCur, intrMat,thetaP2C,T_B2C, k2cRef0);
                                    end
                                end
...
%                                     [reProjErr2,err2] = AngleSpace.ProjectErrorUnderTransform2(k2cCam(1:3,1:3), k2cCam(1:3,4), keyPtIcs, curPtIcs, intrMat);
                                ...
                                thetaRngP2CBeforeNewPlatform = thetaRngP2C;
...
%                                 k2cRef = obj.refAngList4(end) + angOptP2C;
                                ...
                                angOptP2C = []; thetaProbP2C = [];thetaRngP2C = [];thetaSampP2C = []; thetaProbP2CBeforeNewPlatform = []; thetaRngP2CBeforeNewPlatform = []; thetaP2C = [];% thetaRngP2C - thetaP2C;
                            end
                            thetaRange = k2cRef + [obj.configParam.theta_range(1) : obj.configParam.theta_sample_step : obj.configParam.theta_range(2)];
                            thetaRng = thetaRange;
                            [thetaGrid, disparityGrid] = meshgrid(thetaRange, disparityRng);
                            ...
                            if 0
                                ...
                                [thetaProb,idM,angOpt, ReprojErrVecTmp, ReprojErrVecRTmp, ReprojErrVecTmpMatT, ReprojErrVecRTmpMatT,ValidFeatFlag,ValidFeatFlag0,ValidFeatFlagFusion,ValidFeatFlagQuant,ProbReprojVecAll,ProbReprojVecRAll, PixKeyVecTmp, PixKeyVecRTmp, Probb,validFeatFlagFusion,validFeatFlag, ProbReprojVec, ProbReprojVecR,bb,b,pixKeyVecTmpXCoordMatStack,pixKeyVecTmpYCoordMatStack,pixKeyVecRTmpXCoordMatStack,pixKeyVecRTmpYCoordMatStack, ...
                                    thetaExp_tmp0, errEpiline, angOptEpiInit, depthC2KInd_ind]       =   ReplayTheta(obj, thetaRng, b2c, keyCcsXYZAll, intrMat, Pix, disparityRng, baseline, ZZVec1, L2R, pt2dCur, pt2dCurR,ProbZ, ProbZTmp_norm, imgCur, imgCurR,thetaSamp);
                            ...
                            for ft = 1 : IterThetaNum-1
                                ...
                                if 1 % 20191123 use ExpCoord_OnlyP2 to update angOpt
                                    [thetaProb,idM,angOpt, ReprojErrVecTmp, ReprojErrVecRTmp, ReprojErrVecTmpMatT, ReprojErrVecRTmpMatT,ValidFeatFlag,ValidFeatFlag0,ValidFeatFlagFusion,ValidFeatFlagQuant,ProbReprojVecAll, ProbReprojVecRAll, PixKeyVecTmp, PixKeyVecRTmp, Probb, ...
                                        ...
                                        = ReplayTheta(obj, thetaRng, b2c, keyCcsXYZAll, intrMat, Pix, disparityRng, baseline, ZZVec1, L2R, pt2dCur, pt2dCurR,ProbZ./max(ProbZ(:)), ProbZTmp_norm, imgCur, imgCurR,thetaSamp);
                                else
                                    [thetaProb,idM,angOpt, ReprojErrVecTmp, ReprojErrVecRTmp, ReprojErrVecTmpMatT, ReprojErrVecRTmpMatT,ValidFeatFlag,ValidFeatFlag0,ValidFeatFlagFusion,ValidFeatFlagQuant,ProbReprojVecAll, ProbReprojVecRAll, PixKeyVecTmp, PixKeyVecRTmp, Probb, ...
                                        validFeatFlagFusion,validFeatFlag, ProbReprojVec, ProbReprojVecR,bb,b,pixKeyVecTmpXCoordMatStack,pixKeyVecTmpYCoordMatStack,pixKeyVecRTmpXCoordMatStack,pixKeyVecRTmpYCoordMatStack,thetaExp_tmp,errEpiline, angOptEpi,depthC2KInd_ind]...
                                        = ReplayTheta(obj, thetaRng, b2c, keyCcsXYZAll, intrMat, Pix, disparityRng, baseline, ZZVec1, L2R, ExpCoord_OnlyP2, pt2dCurR,ProbZ./max(ProbZ(:)), ProbZTmp_norm, imgCur, imgCurR,thetaSamp);
...
%                                 [thetaRng, thetaSamp] = ArrangeThetaRng(obj,rad2deg(thetaExp_tmp),k2cRef,sc,thetaSamp0);
                            ...
                            if doRoundingTheta
                                [thetaProbK2C_, angOptK2C_, thetaExp_tmpK2C, ~,thetaRngP2C_use] = New_OnlyP2(obj, Pix, pt2dCur, intrMat,angOpt,T_B2C, k2cRef0);
                            else
                                [thetaProbK2C_, angOptK2C_, thetaExp_tmpK2C, ~,thetaRngP2C_use] = New_OnlyP2(obj, Pix, pt2dCur, intrMat,k2cRef0,T_B2C, k2cRef0);
                            end
                            figure(18),hold on;
                            if size(obj.featPtManager.localTrace.ptIcsX, 2) == 2
                                clf;
                            end
                            figure(18);plot(rad2deg(thetaRngP2C_use) - rad2deg(k2cRef0), thetaProbK2C_);hold on;plot(rad2deg(angOptK2C_ - k2cRef0), max(thetaProbK2C_),'or');grid on;
                                    ...
                                    if ~NewFlow
                                        ...
                                        for ft = 1 : IterThetaNum
                                            ...
                                            if 1 % 20191123 use ExpCoord_OnlyP2 to update angOpt
                                                ...
                                                [thetaProb,idM,angOpt, ReprojErrVecTmp, ReprojErrVecRTmp, ReprojErrVecTmpMatT, ReprojErrVecRTmpMatT,ValidFeatFlag,ValidFeatFlag0,ValidFeatFlagFusion,ValidFeatFlagQuant,ProbReprojVecAll, ProbReprojVecRAll, PixKeyVecTmp, PixKeyVecRTmp, Probb, ...
                                                    validFeatFlagFusion,validFeatFlag, ProbReprojVec, ProbReprojVecR,bb,b,pixKeyVecTmpXCoordMatStack,pixKeyVecTmpYCoordMatStack,pixKeyVecRTmpXCoordMatStack,pixKeyVecRTmpYCoordMatStack,thetaExp_tmp,errEpiline, angOptEpi,depthC2KInd_ind]...
                                                    = ReplayTheta(obj, thetaRng, b2c, keyCcsXYZAll, intrMat, Pix, disparityRng, baseline, ZZVec1, L2R, ExpCoord_OnlyP2, pt2dCurR,updatedProbZSum0./max(updatedProbZSum0(:)), ProbZTmp_norm, imgCur, imgCurR,thetaSamp);
...
%                                 obj.twoOnlyP2List = [obj.twoOnlyP2List; [rad2deg([angOptList0' angOptList' angOptEpi k2cRef] - [k2cRef0.*ones(1,2 + 2*IterThetaNum)])] ];
                                obj.twoOnlyP2List = [obj.twoOnlyP2List; [rad2deg([angOptList0' angOptList' angOptEpiInit k2cRef] - [k2cRef0.*ones(1,2 + 2*IterThetaNum)])] ];
                                
                                figure(15);hold on;
                                plot(obj.twoOnlyP2List(:,end),'-sg');
                                colorCell0 = {};
                                colorCell0{1} = '-rx';
                                colorCell0{2} = '-mx';
                                ...
                                plot(obj.twoOnlyP2List(:,end-1),'-*k');
                                legend('k2cRef - k2cRef0','1st theta from p2 and z','2nd theta', 'epipolar line');title('ang - ref (deg)');
...
%                             doProb = 1; idM_Vec = -20:20; debugProb;
    ...
    methods (Static)
        function [depthGTInd, ProbZTmpTmpNormUse, ProbZTmpNorm, peakIdTmp, depthGTIndAll, depthUpdateIndAllUse, ProbZNormSum, NewDispRng, newDispStep, ProbZTmpReSamp] = GetDepthHist(obj, curDispStepList,ProbZ,disparityErrorRound,disparity_sample_step,DispRng,NewDispStep_,depthC2KInd_ind)
...
%             obj.modals = m_;
    ...
    methods (Static)
        function [curPredPtIcs,inTraceFlag,curPredPtIcs0,inTraceFlag0,weightRaw,candX,candY,errPair] = NewTracking(obj,keyFeatNum,prevFeatPtList,ptCcsZ,intrMat,k2cRef,angleModalOrg, keyDepthV, prevDepthV, currDepthV,DepthProbility, DepthId, AngleProbility,reCalc,DispRefineUse__,DispRng)
